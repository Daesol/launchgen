...
export default function PageEditor({ initialConfig, onSave }: PageEditorProps) {
  ...
  return (
    <div className="flex h-full bg-slate-50 overflow-hidden">
      {/* Main Preview Area */}
      <div className={`flex-1 relative transition-all duration-300 ${sidePanelCollapsed ? 'mr-16' : 'mr-80'}`}>
        {/* Preview Controls - Fixed Header */}
        <div className="absolute top-0 left-0 right-0 bg-white border-b border-slate-200 px-6 py-3 flex items-center justify-between z-20">
          <div className="flex items-center gap-4">
            <h1 className="text-lg font-semibold text-slate-800">Landing Page Preview</h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              className="bg-purple-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-purple-700 transition-colors disabled:opacity-60 text-sm"
              onClick={handleSave}
              disabled={saving}
            >
              {saving ? "Saving..." : "Save"}
            ...
            <button
              className="bg-green-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-green-700 transition-colors disabled:opacity-60 text-sm"
        ...
        <div className="absolute top-0 left-0 right-0 bottom-0 overflow-auto bg-slate-100 pt-20 px-6 pb-6">
      ...
      <aside className={`fixed right-0 top-0 h-full bg-white shadow-xl border-l border-slate-200 flex flex-col transition-all duration-300 z-30 ${
