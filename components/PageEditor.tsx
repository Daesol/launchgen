...
export default function PageEditor({ initialConfig, onSave }: PageEditorProps) {
  ...
  // Resize all textareas on initial load and when content changes
  useEffect(() => {
    const textareas = document.querySelectorAll('textarea');
    textareas.forEach(textarea => {
      resizeTextarea(textarea);
    });
  }, [pageContent, pageStyle, expandedSections]); // Re-run when content or section expansion changes
        ...
        <div className={`overflow-y-auto ${sidePanelCollapsed ? 'hidden' : ''}`} style={{ 
          ...
          <div className="p-4 sm:p-6 space-y-6 pb-6">
            ...
            <CollapsibleSection
              ...
              onVisibilityToggle={() => toggleSectionVisibility('features')}
            ...
            >
              ...
              <div>
                <label className="block text-slate-700 font-medium mb-2 text-xs sm:text-sm">Feature Items</label>
            ...
            <CollapsibleSection
              ...
              onVisibilityToggle={() => toggleSectionVisibility('cta')}
              showVisibilityToggle={true}
            >
              <div>
            ...
            <CollapsibleSection
              ...
              onVisibilityToggle={() => toggleSectionVisibility('problemSection')}
              showVisibilityToggle={true}
            >
              <div>
            ...
            <CollapsibleSection
              ...
              isExpanded={expandedSections.solutionSection}
              onToggle={() => toggleSection('solutionSection')}
              isVisible={visibleSections.solutionSection}
              onVisibilityToggle={() => toggleSectionVisibility('solutionSection')}
              showVisibilityToggle={true}
            >
              <div>
            ...
            <CollapsibleSection
              ...
              onVisibilityToggle={() => toggleSectionVisibility('socialProof')}
              showVisibilityToggle={true}
            >
              <div>
            ...
            <CollapsibleSection
              ...
              onVisibilityToggle={() => toggleSectionVisibility('guarantees')}
              showVisibilityToggle={true}
            >
              <div>
            ...
            <CollapsibleSection
              ...
              onVisibilityToggle={() => toggleSectionVisibility('faq')}
              showVisibilityToggle={true}
            >
              <div>
