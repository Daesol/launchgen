  ...
  return (
    <div className="border-b border-[#2D2D2D] px-2 py-1.5 flex items-center justify-between" style={{ backgroundColor: '#0A0A0A' }}>
      ...
      <div className="lg:hidden flex items-center justify-between w-full">
        {/* Left side - Mobile view indicator and QR */}
        <div className="flex items-center space-x-2">
          <span className="text-xs font-medium text-neutral-300">Mobile</span>
          <div className="w-1 h-1 bg-neutral-500 rounded-full"></div>
          <span className="text-xs text-neutral-400">Preview</span>
        </div>

        {/* Right side - Mobile-optimized buttons */}
        <div className="flex items-center space-x-1">
          ...
          {/* Regenerate button - Smaller on mobile */}
          <button
            onClick={onRegenerate}
            disabled={regenerating}
