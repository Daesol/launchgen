...
const testimonials = [
  ...
  },
  {
    ...
    content: "Incredible results! We went from 0 to 1000+ signups in just one week using LaunchGen's landing pages.",
    rating: 5
  },
  {
    name: "David Kim",
    role: "Marketing Director, CloudTech",
    content: "The best investment we've made. Our lead generation increased by 400% and the setup took less than an hour.",
    rating: 5
  },
  {
    name: "Lisa Thompson",
    role: "Founder, GreenEnergy Co",
    content: "LaunchGen transformed our startup's online presence. We're now competing with much larger companies thanks to our professional landing page.",
    rating: 5
  },
  {
    name: "Alex Johnson",
    role: "VP Marketing, FinTech Innovations",
    content: "The AI understands our industry perfectly. Generated content that converts better than our expensive agency's work.",
    rating: 5
  }
]
