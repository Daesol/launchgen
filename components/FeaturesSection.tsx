    ...
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-900/50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-white mb-4">Why Choose LaunchGen?</h2>
          <p className="text-slate-400 max-w-2xl mx-auto">
            Built for founders, marketers, and product teams who want to validate ideas quickly and start collecting leads immediately.
          </p>
        </div>
