...
import type { PageCardProps } from "@/lib/dashboard/types";

// Memoized PageCard component for better performance
const OptimizedPageCard = memo(function PageCard({ 
  page, 
  pageLeads, 
  pageViews, 
  conversionRate, 
  ...
  const formattedDate = useMemo(() => formatDate(page.created_at || new Date().toISOString()), [page.created_at, formatDate]);

  // Memoized conversion rate
  const formattedConversionRate = useMemo(() => conversionRate.toFixed(1), [conversionRate]);
        ...
        <div className="grid grid-cols-3 gap-4 mb-4">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-1 mb-1">
              ...
              <span className="text-sm font-medium text-white">{formattedConversionRate}%</span>
            </div>
  ...
  return (
    ...
    prevProps.page.description === nextProps.page.description &&
    prevProps.page.published === nextProps.page.published &&
    prevProps.pageLeads === nextProps.pageLeads &&
    prevProps.pageViews === nextProps.pageViews &&
    prevProps.conversionRate === nextProps.conversionRate
  );
});

export default OptimizedPageCard;
